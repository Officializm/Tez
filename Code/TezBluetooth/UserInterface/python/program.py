...
def decode_menu_command_code(command):
    ...
    if(command  == 0 ):
        ...
        print("\n   Command == > BOOTLOADER_GET_CHIP_ID")
        COMMAND_BL_GET_CID_LEN             =6
        ...
        print("\n   Command == > BOOTLOADER_GET_READ_PROTECTION_LEVEL_STATUS")
...
while True:
    ...
    print("   BOOTLOADER_GET_HELP--------------------------> 2")
    print("   BOOTLOADER_GET_CHIP_ID-----------------------> 3")
    print("   BOOTLOADER_GET_READ_PROTECTION_LEVEL_STATUS--> 4")
    print("   BOOTLOADER_GO_TO_ADDRESS---------------------> 5")
    print("   BOOTLOADER_FLASH_MASS_ERASE------------------> 6")
    print("   BOOTLOADER_FLASH_ERASE-----------------------> 7")
    print("   BOOTLOADER_MEMORY_WRITE----------------------> 8")
    print("   BOOTLOADER_ENABLE_READ_WRITE_PROTECT---------> 9")
    print("   BOOTLOADER_MEMORY_READ-----------------------> 10")
    print("   BOOTLOADER_READ_SECTOR_PROTECTION_STATUS-----> 11")
    print("   BOOTLOADER_OTP_READ--------------------------> 12")
    print("   BOOTLOADER_DISABLE_READ_WRITE_PROTECT--------> 13")
    print("   BOOTLOADER_MY_NEW_COMMAND--------------------> 14")
    print("   MENU_EXIT------------------------------------> 0")
